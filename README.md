...
Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/pymodbus-feedstock/blob/master/LICENSE.txt)

Summary: A fully featured modbus protocol stack in python

Documentation: https://pythonhosted.org/pymodbus/
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=10508&branchName=master">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/pymodbus-feedstock?branchName=master">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `pymodbus` can be installed with:

```
conda install pymodbus
```

It is possible to list all of the versions of `pymodbus` available on your platform with:
